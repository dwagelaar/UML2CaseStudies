...
/**
 * This is the action bar contributor for the Instantmessenger model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstantmessengerActionBarContributor
	 ...
	 * @generated
	 */
	public InstantmessengerActionBarContributor() {
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(InstantMessengerEditorPlugin.INSTANCE.getString("_UI_InstantmessengerEditor_menu"), "be.ac.vub.uml2cs.instantmessengerMenuID");
		...
		//
		createChildMenuManager = new MenuManager(InstantMessengerEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(InstantMessengerEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(InstantMessengerEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(InstantMessengerEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
